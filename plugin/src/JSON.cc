...
ValPtr BoolConverter::Exec(const rapidjson::Value& val, const TypePtr& type) const
	{
...
ValPtr IntConverter::Exec(const rapidjson::Value& val, const TypePtr& type) const
	{
...
ValPtr CountConverter::Exec(const rapidjson::Value& val, const TypePtr& type) const
	{
...
ValPtr DoubleConverter::Exec(const rapidjson::Value& val, const TypePtr& type) const
	{
...
ValPtr StringConverter::Exec(const rapidjson::Value& val, const TypePtr& type) const
	{
